...
public class UserService : IUserService
{
    ...
    private readonly ICreateUserAllRabbitMQProducer _producesAll;
    private readonly ICreateUserRabbitMQProducer _producesCreateUser;
    private readonly IDeleteUserRabbitMQProducer _producesDeleteUser;
    private readonly IUserRepository _repo;
    private readonly ICacheRepository _repoCache;
    private readonly CreateUserValidator _validator;
    private readonly IUnitOfWork _unitOfWork;

    public UserService(ICreateUserAllRabbitMQProducer producesAll,
                       ICreateUserRabbitMQProducer producesCreateUser,
                       IDeleteUserRabbitMQProducer producesDeleteUser,
