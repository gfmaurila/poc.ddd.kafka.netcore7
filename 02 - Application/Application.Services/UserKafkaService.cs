...
public class UserKafkaService : IUserKafkaService
{
    private readonly IMapper _mapper;
    private readonly ICreateUserAllKafkaProducer _producesAll;
    private readonly ICreateUserKafkaProducer _producesCreateUser;
    private readonly IDeleteUserKafkaProducer _producesDeleteUser;
    private readonly IUserRepository _repo;
    private readonly ICacheRepository _repoCache;
    private readonly CreateUserValidator _validator;
    private readonly IUnitOfWork _unitOfWork;

    public UserKafkaService(ICreateUserAllKafkaProducer producesAll,
                       ICreateUserKafkaProducer producesCreateUser,
                       IDeleteUserKafkaProducer producesDeleteUser,
