...
public class UserServiceTests
{
    ...
    private ICreateUserAllRabbitMQProducer _producesAll;
    private ICreateUserRabbitMQProducer _producesCreateUser;
    private IDeleteUserRabbitMQProducer _producesDeleteUser;
    ...
    public UserServiceTests()
    {
        ...
        _producesAll = Substitute.For<ICreateUserAllRabbitMQProducer>();
        _producesCreateUser = Substitute.For<ICreateUserRabbitMQProducer>();
        _producesDeleteUser = Substitute.For<IDeleteUserRabbitMQProducer>();
