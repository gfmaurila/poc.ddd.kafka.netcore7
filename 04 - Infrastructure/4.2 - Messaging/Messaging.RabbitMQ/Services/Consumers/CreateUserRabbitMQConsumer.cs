...
public class CreateUserRabbitMQConsumer : BackgroundService
{
    ...
    public CreateUserRabbitMQConsumer(IServiceProvider serviceProvider)
    {
    ...
    public async Task CreateUserRedis(UserListDto dto)
    {
        using (var scope = _serviceProvider.CreateScope())
        {
            ...
            await createUserRedis.CreateRedis($"user_id_{dto.Id}", dto, 0);
        }
    }
}
